...
<header>
    <nav class="navbar navbar-dark bg-dark navbar-expand flex-column">
        <div class="container-fluid">
            <a href="" class="navbar-brand">Admin App</a>
            <a class="btn nav-item rounded text-white" href="javascript:void(0);" onclick="mage.setUrl('<?= UrlManager::getUrl('view', 'admin_cart', null, true) ?>').resetParams().load()" class="nav-link"><i class="fa fa-shopping-cart fa-fw" aria-hidden="true"></i> Cart</a>
        </div>
