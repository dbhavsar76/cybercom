<nav class="navbar navbar-dark bg-dark navbar-expand">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item"><a href="<?= Model_Core_UrlManager::getUrl('grid', 'admin', null, true) ?>" class="nav-link">Admins</a></li>
            <li class="nav-item"><a href="<?= Model_Core_UrlManager::getUrl('grid', 'customer', null, true) ?>" class="nav-link">Customers</a></li>
            <li class="nav-item"><a href="<?= Model_Core_UrlManager::getUrl('grid', 'customerGroup', null, true) ?>" class="nav-link">Customer Groups</a></li>
            ...
            <li class="nav-item"><a href="<?= Model_Core_UrlManager::getUrl('grid', 'paymentMethod', null, true) ?>" class="nav-link">Payment Methods</a></li>
